...
/**
 * Adapted for Verily by John P. Bloch (2012-06-08)
 *  - Updated OOP to use more restricted visibility
 *  - Added the PasswordHasher implementation
 */

namespace Verily\Lib;

class PasswordHash implements PasswordHasher {
